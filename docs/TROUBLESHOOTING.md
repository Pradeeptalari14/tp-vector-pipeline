# 🔧 Troubleshooting Guide — Vector Log Pipeline Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-vector-pipeline/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/vector-pipeline/)
